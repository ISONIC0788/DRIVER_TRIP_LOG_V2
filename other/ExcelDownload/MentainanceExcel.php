...
$sheet->setCellValue('C1', 'Vehicle ID');
$sheet->setCellValue('D1', 'Mentaince Type');
$sheet->setCellValue('E1', 'Start service Date');
$sheet->setCellValue('F1', 'End Service Date');
...
// Set filename
$filename = 'Mentainance_Report.xlsx';
