...
<html lang="en">
  ...
  <head>
    <title>Admin Page | Mentainance Records</title>
    <!-- [Meta] -->
    <meta charset="utf-8" />
            ...
            <div class="card">
              <div class="card-header">
                ...
                <p> <i class="bi bi-file-earmark-word-fill col-3" style='color:blue'></i> Word Doc 2007 
                  <a href="./WordDownload/financialWord207.php"><i class="ti ti-download" title='Download Word Doc'></i></a>
                  <i class="bi bi-file-spreadsheet col-3" style='color:green'></i>Excel Sheet 
                   <a href="./ExcelDownload/MentainanceExcel.php"><i class="ti ti-download" title='Download Word Doc'></i></a></p>
                   
                 </p>
              
              </div>
              <div class="card-body">
                <!-- [view for mantaince activity ] -->
                 ...
                 <table class ="table table-hover">
                  ...
                  <tbody>
                    <tr>
                      <?php
                        $sqluser = "SELECT * FROM maintenance";
